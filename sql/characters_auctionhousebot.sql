...
CREATE TABLE `auctionhousebot` (
  ...
  `minpricegreen` int(11) default '150' COMMENT 'Minimum price of Green items (percentage).',
  `maxpricegreen` int(11) default '250' COMMENT 'Maximum price of Green items (percentage).',
  `minpriceblue` int(11) default '150' COMMENT 'Minimum price of Blue items (percentage).',
  `maxpriceblue` int(11) default '250' COMMENT 'Maximum price of Blue items (percentage).',
  `minpricepurple` int(11) default '150' COMMENT 'Minimum price of Purple items (percentage).',
  `maxpricepurple` int(11) default '250' COMMENT 'Maximum price of Purple items (percentage).',
  `minbidpricewhite` int(11) default '100' COMMENT 'Starting bid price of White items as a percentage of the randomly chosen buyout price. Default: 100 (Bid and buyout price the same)',
  ...
  `minbidpricegreen` int(11) default '100' COMMENT 'Starting bid price of Green items as a percentage of the randomly chosen buyout price. Default: 100 (Bid and buyout price the same)',
  ...
  `minbidpriceblue` int(11) default '100' COMMENT 'Starting bid price of Blue items as a percentage of the randomly chosen buyout price. Default: 100 (Bid and buyout price the same)',
  ...
  `minbidpricepurple` int(11) default '100' COMMENT 'Starting bid price of Purple items as a percentage of the randomly chosen buyout price. Default: 100 (Bid and buyout price the same)',
  ...
  `buyerpricewhite` int(11) default '2' COMMENT 'Multiplier to vendorprice when buying white items from auctionhouse',
  `buyerpricegreen` int(11) default '2' COMMENT 'Multiplier to vendorprice when buying green items from auctionhouse',
  `buyerpriceblue` int(11) default '2' COMMENT 'Multiplier to vendorprice when buying blue items from auctionhouse',
  `buyerpricepurple` int(11) default '2' COMMENT 'Multiplier to vendorprice when buying purple items from auctionhouse',
